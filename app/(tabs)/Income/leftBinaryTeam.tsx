...
const LeftBinaryTeam = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(`https://emrwalletbackend.vercel.app/users/${userId}/L?page=${page}`, {
                headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Left Binary Team</Text>
