    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `https://emrwalletbackend.vercel.app/api/level-data/${selectedUserId}`,
                {
                    headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Pool 1 Team</Text>
            ...
            <View>
            <UserDropdown onValueChange={handleDropdownValueChange}/>
            </View>
