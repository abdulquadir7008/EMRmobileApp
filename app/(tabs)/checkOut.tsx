      ...
      <View style={styles.container}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', width:'100%' }}>
            ...
            <Text style={styles.grandTotal}> 25</Text>
          </View>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', width:'100%'  }}>
            <Text style={{
              fontSize: 14,
              color: '#333',
              fontFamily: 'SpaceMono', marginLeft: 10, marginTop: 5, fontWeight:'bold'
            }}>Total</Text>
            <Text style={styles.grandTotal}> ${getTotalPrice() + 25}</Text>
          </View>
          <View>
            <TouchableOpacity  style={styles.checkoutButton} onPress={() => navigation.navigate('paymentSucess')}>
