...
import BoosterThreeDropdown from './boosterThreeDropdown';


const BoosterThreeHistory = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `https://emrwalletbackend.vercel.app/boosterthreehistory/${selectedUserId}`,
                {
                    headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Booster 1 (B3) History</Text>
            ...
            <View>
            <BoosterThreeDropdown onValueChange={handleDropdownValueChange}/>
            </View>
...
export default BoosterThreeHistory;