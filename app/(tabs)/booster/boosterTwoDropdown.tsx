...
function BoosterTwoDropdown({ onValueChange }) { // Add onValueChange prop
    ...
    useEffect(() => {
        if (tokenLoaded && userAuth) {
            axios
                .get(`https://emrwalletbackend.vercel.app/api/boosterteamtwo/${userId}`, {
                    headers: {
...
export default BoosterTwoDropdown;