...
const BoosterTwoIncome = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(`https://emrwalletbackend.vercel.app/boostertwohis/${userId}?page=${page}`, {
                headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Booster 2 History</Text>
...
export default BoosterTwoIncome;