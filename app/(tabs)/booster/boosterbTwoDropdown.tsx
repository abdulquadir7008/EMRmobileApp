...
function BoosterbTwoDropdown({ onValueChange }) { // Add onValueChange prop
    ...
    useEffect(() => {
        if (tokenLoaded && userAuth) {
            axios
                .get(`https://emrwalletbackend.vercel.app/api/booster2team/${userId}`, {
                    headers: {
...
export default BoosterbTwoDropdown;