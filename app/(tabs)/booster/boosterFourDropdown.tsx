...
function BoosterFourDropdown({ onValueChange }) { // Add onValueChange prop
    ...
    useEffect(() => {
        if (tokenLoaded && userAuth) {
            axios
                .get(`https://emrwalletbackend.vercel.app/api/boosterteamfour/${userId}`, {
                    headers: {
...
export default BoosterFourDropdown;