...
function BoosterFiveDropdown({ onValueChange }) { // Add onValueChange prop
    ...
    useEffect(() => {
        if (tokenLoaded && userAuth) {
            axios
                .get(`https://emrwalletbackend.vercel.app/api/boosterteamfive/${userId}`, {
                    headers: {
...
export default BoosterFiveDropdown;