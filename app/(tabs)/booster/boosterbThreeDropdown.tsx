...
function BoosterbThreeDropdown({ onValueChange }) { // Add onValueChange prop
    ...
    useEffect(() => {
        if (tokenLoaded && userAuth) {
            axios
                .get(`https://emrwalletbackend.vercel.app/api/booster3team/${userId}`, {
                    headers: {
...
export default BoosterbThreeDropdown;