...
import BoosterSixDropdown from './boosterSixDropdown';


const BoosterSixHistory = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `https://emrwalletbackend.vercel.app/boostersixhistory/${selectedUserId}`,
                {
                    headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Booster 1 (B6) History</Text>
            ...
            <View>
            <BoosterSixDropdown onValueChange={handleDropdownValueChange}/>
            </View>
...
export default BoosterSixHistory;