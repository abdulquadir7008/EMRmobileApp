...
const BoosterThreeIncome = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(`https://emrwalletbackend.vercel.app/boosterthreehist/${userId}?page=${page}`, {
                headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Booster 3 History</Text>
...
export default BoosterThreeIncome;