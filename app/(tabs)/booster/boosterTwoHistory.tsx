...
import BoosterTwoDropdown from './boosterTwoDropdown';


const BoosterTwoHistory = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `https://emrwalletbackend.vercel.app/boostertwohistory/${selectedUserId}`,
                {
                    headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Booster 1 (B2) History</Text>
            ...
            <View>
            <BoosterTwoDropdown onValueChange={handleDropdownValueChange}/>
            </View>
...
export default BoosterTwoHistory;