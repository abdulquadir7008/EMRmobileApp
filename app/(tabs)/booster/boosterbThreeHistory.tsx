...
import BoosterbThreeDropdown from './boosterbThreeDropdown';



const BoosterbThreeHistory = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `https://emrwalletbackend.vercel.app/booster3teamhistory/${selectedUserId}`,
                {
                    headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Booster 3 Team History</Text>
            ...
            <View>
            <BoosterbThreeDropdown onValueChange={handleDropdownValueChange}/>
            </View>
...
export default BoosterbThreeHistory;