...
import BoosterFiveDropdown from './boosterFiveDropdown';



const BoosterFiveHistory = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `https://emrwalletbackend.vercel.app/boosterfivehistory/${selectedUserId}`,
                {
                    headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Booster 1 (B5) History</Text>
            ...
            <View>
            <BoosterFiveDropdown onValueChange={handleDropdownValueChange}/>
            </View>
...
export default BoosterFiveHistory;