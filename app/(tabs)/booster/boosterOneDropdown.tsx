...
function BoosterOneDropdown({ onValueChange }) { // Add onValueChange prop
    ...
    useEffect(() => {
        if (tokenLoaded && userAuth) {
            axios
                .get(`https://emrwalletbackend.vercel.app/api/boosterteamone/${userId}`, {
                    headers: {
...
export default BoosterOneDropdown;