...
import BoosterbTwoDropdown from './boosterbTwoDropdown';



const BoosterbTwoHistory = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `https://emrwalletbackend.vercel.app/booster2teamhistory/${selectedUserId}`,
                {
                    headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Booster 2 Team History</Text>
            ...
            <View>
            <BoosterbTwoDropdown onValueChange={handleDropdownValueChange}/>
            </View>
...
export default BoosterbTwoHistory;