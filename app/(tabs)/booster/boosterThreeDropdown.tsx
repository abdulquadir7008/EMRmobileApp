...
function BoosterThreeDropdown({ onValueChange }) { // Add onValueChange prop
    ...
    useEffect(() => {
        if (tokenLoaded && userAuth) {
            axios
                .get(`https://emrwalletbackend.vercel.app/api/boosterteamthree/${userId}`, {
                    headers: {
...
export default BoosterThreeDropdown;