...
import BoosterOneDropdown from './boosterOneDropdown';


const BoosterOneHistory = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `https://emrwalletbackend.vercel.app/boosteronehistory/${selectedUserId}`,
                {
                    headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Booster 1 (B1) History</Text>
            ...
            <View>
            <BoosterOneDropdown onValueChange={handleDropdownValueChange}/>
            </View>
...
export default BoosterOneHistory;