...
const BoosterOneLevelIncome = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(`https://emrwalletbackend.vercel.app/boosteronelevelincome/${userId}?page=${page}`, {
                headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Booster One Level History</Text>
...
export default BoosterOneLevelIncome;