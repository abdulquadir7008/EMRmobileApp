...
const RankClubRoyal = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(`https://emrwalletbackend.vercel.app/rankclubroyal/${userId}?page=${page}`, {
                headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Rank Club Royalty</Text>
