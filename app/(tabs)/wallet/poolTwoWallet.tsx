...
const poolTwoWallet = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(`https://emrwalletbackend.vercel.app/pool-two-transactions/${userId}?page=${page}`, {
                headers: {
    ...
    const submitData = async () => {
        ...
        try {
            const response = await axios.post(
                `https://emrwalletbackend.vercel.app/pool-two-wallet/${userId}`,
                formData,
                {
                    headers: {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Pool 2 Wallet</Text>
