...
import PoolTwoUserDropdown from './poolUserDropdown';
...
const PooltwoTeam = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `https://emrwalletbackend.vercel.app/api/pooltwodata/${selectedUserId}`,
                {
                    headers: {
    ...
    const renderItem = ({ item }) => {
        ...
        return (
            <View key={item.uniqueKey} style={item.level % 2 === 0 ? styles.tableRow : styles.oddRow}>
                <Text style={styles.tableCell}>{item.level}</Text>
                <Text style={[styles.tableCell, { fontWeight: 'bold' }]}>{item.level}</Text>
    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.title}>Pool 2 Team</Text>
            ...
            <View>
            <PoolTwoUserDropdown onValueChange={handleDropdownValueChange}/>
            </View>
