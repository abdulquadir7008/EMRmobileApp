...
function PoolTwoUserDropdown({ onValueChange }) { // Add onValueChange prop
    ...
    useEffect(() => {
        if (tokenLoaded && userAuth) {
            axios
                .get(`https://emrwalletbackend.vercel.app/api/pooltwoteam/${userId}`, {
                    headers: {
...
export default PoolTwoUserDropdown;